            ...
            <div class="col-lg-12 mb-5">
                <div class="flex">
                    <a href="{{ route('admin.ads.create') }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-plus"></i> Manage Ads
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                                ...
                                @foreach ($ads as $adsData)
                                    <tr>
                                        ...
                                        @if (strtolower($adsData->ads_type) == 'app' && strtolower($adsData->preffered_type) == 'custom')
                                            <td>{{ $adActivityCount }}</td>
                                        @else
                                            <td>-</td>
                                        @endif
                                      ...
                                      {{--   <td>
                                            <div class="btn-group">
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{route('admin.ads.edit', $adsData->id)}}">
