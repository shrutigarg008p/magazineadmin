  ...
  <section class="md_hg">
      <div class="container-fluid">
          <div class="row">
              <div class="col-md-5">
                  <div class="md_left">
                      <img src="{{asset('/storage/').'/'.$newsDatas->cover_image}}" class="img-fluid" alt="Newspaper Image" >
                      {{-- epub path --}}
                      <button style="display:none"  id="epub_path"value="{{asset('/storage/').'/'.$newsDatas->file}}"></button>
                      {{-- end --}}
                  </div>
              </div>
              <div class="col-md-7">
                  <div class="heading_share_icon">
                      <h1 class="md_hg_heading">{{$newsDatas->category->name}}</h1>
                      {{-- <div class="share_icon_right">
                          <img src="img/icon-share.png">
                      </div> --}}
                  </div>
                  <ul class="source_date">
                      <li class="sd_list">{{$newsDatas->publication->name}} | {{date('d M,Y', strtotime($newsDatas->created_at))}}</li>
                      {{-- <li class="sd_list">|</li>
                      <li class="sd_list">July 16, 2021</li> --}}
                  </ul>
                  <div class="magazine_d_price">${{$newsDatas->price}}</div>
                  <div class="md_text_start">
                      <h2 class="mdtext_heading">Information</h2>
                      <p class="md_text_detail">{{$newsDatas->short_description}}</p>
                  </div>
