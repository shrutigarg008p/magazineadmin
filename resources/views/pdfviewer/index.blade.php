...
@endsection
@section('content')
   <section class="md_hg drce-998iup98777">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row mb-4">
                    <div class="col-12 col-sm-11">
                      <h1 class="md_hg_heading">{{$magDatas->title}}</h1>
                    </div>
                    <div class="col-12 col-sm-1 mt-3 mt-sm-0">
                      <div class="share_icon_right">
                        <img src="{{url('assets/frontend/img/icon-share.png')}}" data-toggle="modal" data-target="#socialModal" data-toggle="modal" data-target="#socialModal">
                      </div>

                      @include('customer.pages.social', ['contentURL' => url("magazine/$magDatas->id/details")])
                    </div>
                  </div>
                    {{-- <ul class="source_date">
                        <li class="sd_list">{{$magDatas->publication->name}} | {{date('d M,Y', strtotime($magDatas->created_at))}}</li>
                     
                    </ul> --}}
                   {{--  <div class="magazine_d_price"> ${{$magDatas->price}}</div>
                    
                    <div class="md_text_start">
                        <h2 class="mdtext_heading">Information</h2>
                        <p class="md_text_detail">{{$magDatas->short_description}}</p>
                    </div> --}}
                        ...
                        <div id="outerContainer">
                          ...
                          <div id="sidebarContainer">
                            <div id="toolbarSidebar">
                              <div class="splitToolbarButton toggled" style="display:none">
                                <button id="viewThumbnail" class="toolbarButton toggled" title="Show Thumbnails" tabindex="2" data-l10n-id="thumbs">
                                   <span data-l10n-id="thumbs_label" style="display:none">Thumbnails</span>
                                </button>
                                ...
                                <div>
                                @if($subscribed == "1")
                                 <button id="ep" value="{{asset('/storage/').'/'.$magDatas->file}}"></button>
                                @else
                                <button id="ep" value="{{!empty($magDatas->file_preview ) ? asset('/storage/').'/'.$magDatas->file_preview : ''}}"></button>
                            ...
                            <div id="sidebarContent">
                              ...
                              <div id="outlineView" class="hidden" style="display:none">
                              </div>
                                ...
                                <div id="toolbarViewer" >
                                  <div id="toolbarViewerLeft">
                                    ...
                                    <div class="splitToolbarButton hiddenSmallView">
                                      <button style="display:none"class="toolbarButton pageUp" title="Previous Page" id="previous" tabindex="13" data-l10n-id="previous">
                                        <span data-l10n-id="previous_label">Previous</span>
                                      </button>
                                      <div class="splitToolbarButtonSeparator"></div>
                                      <button style="display:none"class="toolbarButton pageDown" title="Next Page" id="next" tabindex="14" data-l10n-id="next">
                                        <span data-l10n-id="next_label">Next</span>
                                      </button>
                                    </div>
                                    <input type="number" step="any" id="pageNumber" class="toolbarField pageNumber" title="Page" value="1" size="4" min="1" tabindex="15" data-l10n-id="page">
                          ...
                          <div id="overlayContainer" class="hidden" style="display:none">
                              ...
                              <div id="toolbarSidebar">
                                <div class="splitToolbarButton toggled" style="display:none">
                                  ...
                                  <button id="viewAttachments" class="toolbarButton" title="Show Attachments" tabindex="4" data-l10n-id="attachments">
                                   ...
                                   {{-- <button id="ep" value="{{asset('/storage/').'/'.$magDatas->file}}"></button> --}}
                                   @if($subscribed == "1")
                                 <button id="ep" value="{{asset('/storage/').'/'.$magDatas->file_converted}}"></button>
                                @else
                                <button id="ep" value="{{!empty($magDatas->file_preview ) ? asset('/storage/').'/'.$magDatas->file_preview : "" }}"></button>
