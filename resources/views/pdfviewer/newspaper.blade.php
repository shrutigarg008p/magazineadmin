                ...
                <div class="col-md-12">
                  <div class="row mb-4">
                    <div class="col-12 col-sm-11">
                      <h1 class="md_hg_heading">{{$newsDatas->title}}</h1>
                    </div>
                    <div class="col-12 col-sm-1 mt-3 mt-sm-0">
                      ...
                      @include('customer.pages.social', ['contentURL' => url("newspapers/$newsDatas->id/details")])
                    </div>
                  </div>
                    ...
                    <div class="pdf-wrapper">
                      ...
                      {{-- <h3>Pdf File</h3> --}}
                      {{--  <iframe src="{{ asset("storage/{$newsDatas->file}") }}" frameBorder="0" scrolling="auto"
                            ...
                            <div id="toolbarSidebar">
                              <div class="splitToolbarButton toggled" style="display:none">
                                ...
                                <button id="viewAttachments" class="toolbarButton" title="Show Attachments" tabindex="4" data-l10n-id="attachments">
                                 ...
                                 {{-- <button id="ep" value="{{asset('/storage/').'/'.$newsDatas->file}}"></button> --}}
                                  @if($subscribed == "1")
                                 <button id="ep" value="{{asset('/storage/').'/'.$newsDatas->file}}"></button>
                                @else
                                <button id="ep" value="{{!empty($newsDatas->file_preview) ? asset('/storage/').'/'.$newsDatas->file_preview : ''}}"></button>
                            ...
                            <div id="toolbarSidebar">
                              <div class="splitToolbarButton toggled" style="display:none">
                                ...
                                <button id="viewAttachments" class="toolbarButton" title="Show Attachments" tabindex="4" data-l10n-id="attachments">
                                 ...
                                 {{-- <button id="ep" value="{{asset('/storage/').'/'.$newsDatas->file}}"></button> --}}
                                  @if($subscribed == "1")
                                 <button id="ep" value="{{asset('/storage/').'/'.$newsDatas->file_converted}}"></button>
                                @else
                                <button id="ep" value="{{!empty($newsDatas->file_preview ) ? asset('/storage/').'/'.$newsDatas->file_preview : ''}}"></button>
