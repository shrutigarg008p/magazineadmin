        ...
        <div class="container">
            ...
            <div class="tabnews_tabs one_time_purchase">
                <div class="all_magazines">
                    <a href="{{ url("newspapers/$datas->id/details") }}">
                    ...
                    <div class="magazine_with_price_btns"></div>
                </div>
                ...
                <div class="plans_checkout">
                    ...
                    <form method="POST" action="{{ route('buy_news') }}" accept-charset="UTF-8" class="form-horizontal"
                        role="form">
                        <div class="row" style="margin-bottom:40px;">
                            <div class="col-md-12">
                                ...
                                @if ($getTable == 'newspapers')
                                    <input type="hidden" name="type" class="subsc_day" value="newspaper">
                                @else
                                @endif
