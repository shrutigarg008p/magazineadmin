   ...
   <section class="md_hg">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5">
                    <div class="md_left">
                         <img src="{{asset('/storage/').'/'.$magDatas->cover_image}}" class="img-fluid" alt="Magazine Image" >
                          {{-- epub path --}}
                          <button style="display:none"  id="epub_path"value="{{asset('/storage/').'/'.$magDatas->file}}"></button>
                          {{-- end --}}
                    </div>
                </div>
                <div class="col-md-7">
                    ...
                    <ul class="source_date">
                       ...
                       {{--  <li class="sd_list">{{date('d M,Y', strtotime($magDatas->created_at))}}</li> --}}
                    </ul>
                    ...
                    {{-- <div class="buttons_group">
                        ...
                        <button class="md_download">Download</button>
                    </div>
                    <div class="premium_icon"><img src="img/icon-premium.png" alt=""> Premium Edition</div> --}}
                    <div class="pdf-wrapper">
                      @if($magDatas->file_type == "pdf")
                      <h3>Pdf File</h3>
                      {{--  <iframe src="{{ asset("storage/{$magDatas->file}") }}" frameBorder="0" scrolling="auto"
                      height="340px" width="700px "></iframe> --}}
                      {{-- flip pdf --}}
