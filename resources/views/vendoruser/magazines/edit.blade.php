        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="card">
                    ...
                    <form action="{{ route('vendor.magazines.update', ['magazine' => $magazine]) }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="apple_product_id"
                                    ...
                                    value="{{ old('apple_product_id', $magazine->apple_product_id) }}" required>
                            ...
                            <div class="form-group">
                                <img class="img-fluid" src="{{ asset("storage/{$magazine->thumbnail_image}") }}"
                                    alt="{{ $magazine->title }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="icheck-primary">
                                    <input type="checkbox" id="is_free" name="is_free" value="1" {{$magazine->is_free ? 'checked':''}}>
                                    <label for="is_free">
                                        Is magazine free
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                @elseif($magazine->file_converted)
                                <h4>EPUB FILE</h4>
                                <iframe src="{{ asset("storage/{$magazine->file_converted}") }}" frameBorder="0" scrolling="auto" height="100%" width="100%"></iframe>
                                @endif
                            </div>
                            {{--<div class="form-group">
                                <label for="file">
