        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="card">
                    ...
                    <form action="{{ route('vendor.magazines.store') }}" class="submit-via-ajax" method="post" enctype="multipart/form-data" data-parsley-validate id="form" >
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {{-- <div class="form-check">
                                    <input type="radio" name="file_type" class="form-check-input grid @error('file_type') is-invalid @enderror" value="grid" {{old('file_type') == 'grid' ? 'checked' : ''}}>
